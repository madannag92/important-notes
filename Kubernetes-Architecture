...
A guide to Kubernetes, a container orchestration tool.
Kubernetes
...
whenDeleted: This is the behavior when a statefulset is deleted. whenScaled: This is the behavior when the replicas count of StatefulSet is reduced.
...
Check out Kustomize Page for more details.
...
CD is a practice that enables the automation of the software delivery process. I more like how we can bring those changes to the Kubernetes cluster. It is used to automate the process like:
...
What's next?
Commands - Learn about the commands that you can use with Kubernetes.
Learning Resources - Learn more about Kubernetes with these resources.
Other Resources - Explore more about Kubernetes with these resources.
Playground - Play with Kubernetes in the browser.
